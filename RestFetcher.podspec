#
#  Be sure to run `pod spec lint RestFetcher.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Charles Oder"
  # s.authors            = { "Charles Oder" => "charles@oder.us" }
  # s.social_media_url   = "http://twitter.com/Charles Oder"
  ...
  s.source       = { :git => "https://github.com/charles-oder/rest-fetcher-swift.git", :tag => "0.0.1" }
